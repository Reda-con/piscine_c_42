...
/*   main.c                                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: iblinov <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/29 18:18:01 by iblinov           #+#    #+#             */
/*   Updated: 2018/08/23 11:07:51 by reda-con         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int     main(int ac, char **av)
{
	...
	printf("= ex00 =\n");
	t_list *elem = ft_create_elem(foo_data);
	ft_print_list(elem);
	if (elem->data == foo_data && elem->next == NULL)
		printf("\nOK\n");
	else
		printf("\nError!!!!!!!\n");
	...
	printf("\n= ex02 =\n");
	ft_print_list(elem);
	ft_list_push_front(&elem, bar_data);
	ft_print_list(elem);
	...
	printf("\n= ex05 =\n");
	t_list  *params_list = ft_list_push_params(ac - 1, av + 1);
